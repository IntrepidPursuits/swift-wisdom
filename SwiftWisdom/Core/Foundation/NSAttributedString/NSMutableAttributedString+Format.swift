...
public extension NSMutableAttributedString {
     ...
     */
    convenience init(formatString: String, attributes: [NSAttributedString.Key: AnyObject], arguments: String...) {
    ...
    /**
     ...
     - returns: NSMutableAttributedString with the attributes applied to argument strings.
     */
    convenience init(formatString string: String, attributes: [NSAttributedString.Key: AnyObject]?, arguments: [NSAttributedString]) {
